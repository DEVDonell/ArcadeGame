...
window.onload = function() {
    ...
    update();
	// More responsive controls (keydown instead of keyup)
...
function draw() {
	...
	// Try to apply the nextDirection if possible
	if (nextDirection) {
		const tempDirection = pacman.direction;
		const tempX = pacman.x;
		const tempY = pacman.y;
	...
	// Wraparound logic for Pac-Man (horizontal)
...
function movePacman(e) {
    ...
    if (gameOver) {
        ...
        return; // Don’t move during game over
